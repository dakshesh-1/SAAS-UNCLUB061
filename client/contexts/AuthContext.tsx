...
const mockUsers: User[] = [
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    ...
    badges: [
      { id: 1, name: 'Music Fan', icon: 'Music', color: 'from-unclub-blue to-party-blue' },
      { id: 2, name: 'Newcomer', icon: 'Star', color: 'from-unclub-pink to-party-pink' },
    ],
  },
  {
    id: '3',
    ...
    coverImage: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    ...
    badges: [
      { id: 1, name: 'Tech Guru', icon: 'Laptop', color: 'from-unclub-blue to-party-blue' },
      { id: 2, name: 'Host Pro', icon: 'Users', color: 'from-unclub-red to-party-red' },
      { id: 3, name: 'Verified', icon: 'Zap', color: 'from-party-electric to-unclub-hotpink' },
    ],
  },
];
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const login = async (email: string, password: string): Promise<boolean> => {
    ...
    if (user && password) { // In real app, password would be verified by backend
      setCurrentUser(user);
