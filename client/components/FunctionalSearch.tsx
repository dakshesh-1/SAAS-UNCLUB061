...
const popularSearches = [
  "Pool Party", "Rooftop Vibes", "Birthday Bash", "Beach Party", 
  "House Party", "Club Night", "BBQ Party", "Game Night"
];

const trendingLocations = [
  "Los Angeles", "New York", "Miami", "Las Vegas", 
  "Austin", "Chicago", "San Francisco", "Denver"
];

const categories = [
  "All Events", "Parties", "Concerts", "Festivals", 
  "Clubs", "Bars", "Outdoor", "Private Events"
];
          ...
          {showSuggestions && (
            ...
            >
              <div className="border-t border-gray-200 pt-6">
                <div className="mb-4">
                  <h4 className="text-sm font-bold text-gray-700 mb-3">🔥 Trending Searches</h4>
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-700 mb-3">📍 Popular Cities</h4>
                  <div className="flex flex-wrap gap-2">
            ...
            >
              <div className="border-t border-gray-200 pt-6 mt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Vibe</label>
                    <Select>
                      <SelectTrigger className="rounded-xl">
          ...
          <Card className="bg-white/90 backdrop-blur-sm rounded-2xl border-0 shadow-lg">
            <CardContent className="p-4">
              <div className="text-sm text-gray-600">
                🎉 Found <span className="font-bold text-unclub-blue">42 parties</span> matching "{searchParams.query}"
              </div>
            </CardContent>
          </Card>
        </motion.div>
